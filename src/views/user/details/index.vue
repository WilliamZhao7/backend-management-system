    ...
    <el-form :inline="true" class="form" :model="searchResult">
      <el-form-item label="User Id:">
        <el-input
          ...
          v-model="searchResult.userId"
        ></el-input>
      </el-form-item>
      <el-form-item label="Username:">
        <el-input
          placeholder="Search by username"
          v-model="searchResult.userName"
        ></el-input>
      </el-form-item>
      <el-form-item label="Nickname:">
        <el-input
          placeholder="Search by nickname"
          v-model="searchResult.nickName"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="Mobile:">
        <el-input
          ...
          v-model="searchResult.mobile"
        ></el-input>
      </el-form-item>
      <el-form-item label="Address:">
        <el-input
          placeholder="Search by address"
          v-model="searchResult.address"
        ></el-input>
      </el-form-item>
